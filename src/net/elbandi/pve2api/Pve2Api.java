...
public class Pve2Api {
    ...
    private JSONObject pve_action(String Path, RestClient.RequestMethod method,
        ...
        System.out.println("le data : " + data);
        try {
    ...
    public String deleteQemu(String node, int vmid) throws LoginException, JSONException,
            IOException {
    ...
    public VmOpenvz getOpenvzCT(String node, int vmid) throws JSONException, LoginException,
        ...
        JSONObject obj = jObj.getJSONObject("data");
                //obj.put("vmid", vmid);
        //obj.put("ip_address", "192.168.100.60");
        System.out.println("le JSON : " + jObj.getJSONObject("data"));
    ...
    public void updateOpenvz(String node, VmOpenvz vm) throws LoginException, JSONException, IOException {
        Map<String, String> parameterData = vm.getsUpdatesParams();
        System.out.println(parameterData.toString());
        //String path = "/nodes/" + node + "/openvz/"+vm.getVmid()+"/config";
        JSONObject jsonObject = pve_action("/nodes/proxmox/openvz/" + vm.getVmid() + "/config", RestClient.RequestMethod.PUT, parameterData);
    ...
    public String stopOpenvz(String node, int vmid, Map<String, String> data)
            throws LoginException, JSONException, IOException {
